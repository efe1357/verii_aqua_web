    ...
    const logicalMenuStructure: NavItem[] = [
      ...
      },
      {
        ...
        children: [
          ...
          { title: sidebarT('aquaProjectFeedFishSummaryReport'), href: '/aqua/reports/project-feed-fish-summary' },
      ...
      },
      {
        ...
        children: [
          ...
          { title: sidebarT('aquaCurrentDirections'), href: '/aqua/definitions/current-directions' },
