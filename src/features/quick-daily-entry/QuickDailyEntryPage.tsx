  ...
  return (
    <div className="w-full space-y-6 pb-10 animate-in fade-in duration-500">
      ...
      <OperationTypeTabs
        ...
        mortalityTab={<Suspense fallback={<LazyTabFallback />}><MortalityQuickForm projectId={projectId} projectCageId={projectCageId} mortalityDate={selectedDate} onSubmit={handleMortalitySubmit} isSubmitting={createMortalityLineWithAutoHeader.isPending} canSubmit={canCreateQuickDailyEntry} /></Suspense>}
