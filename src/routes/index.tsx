...
const ProjectsPage = lazyImport(() => import('@/features/projects/components/ProjectsPage.tsx'), 'ProjectsPage', ['aqua', 'projects']);
const CagesPage = lazyImport(() => import('@/features/cages/components/CagesPage.tsx'), 'CagesPage', ['aqua', 'cages']);
const CageWarehouseMappingsPage = lazyImport(() => import('@/features/cages/components/CageWarehouseMappingsPage.tsx'), 'CageWarehouseMappingsPage', ['aqua', 'cages']);
const ProjectCageAssignmentsPage = lazyImport(() => import('@/features/project-cages/components/ProjectCageAssignmentsPage.tsx'), 'ProjectCageAssignmentsPage', ['aqua', 'project-cages']);
const WeatherSeveritiesPage = lazyImport(() => import('@/features/weather/components/WeatherSeveritiesPage.tsx'), 'WeatherSeveritiesPage', ['aqua', 'weather']);
const WeatherTypesPage = lazyImport(() => import('@/features/weather/components/WeatherTypesPage.tsx'), 'WeatherTypesPage', ['aqua', 'weather']);
const SeaWaterTemperaturesPage = lazyImport(() => import('@/features/sea-water-temperature/components/SeaWaterTemperaturesPage.tsx'), 'SeaWaterTemperaturesPage', ['aqua', 'sea-water-temperature']);
const WindDirectionsPage = lazyImport(() => import('@/features/wind-direction/components/WindDirectionsPage.tsx'), 'WindDirectionsPage', ['aqua', 'wind-direction']);
const CurrentDirectionsPage = lazyImport(() => import('@/features/current-direction/components/CurrentDirectionsPage.tsx'), 'CurrentDirectionsPage', ['aqua', 'current-direction']);
const NetOperationTypesPage = lazyImport(() => import('@/features/net-operations/components/NetOperationTypesPage.tsx'), 'NetOperationTypesPage', ['aqua', 'net-operations']);
const AquaSettingsPage = lazyImport(() => import('@/features/aqua-settings/pages/AquaSettingsPage.tsx'), 'AquaSettingsPage', 'aqua');
const GoodsReceiptsPage = lazyImport(() => import('@/features/goods-receipts/components/GoodsReceiptsPage.tsx'), 'GoodsReceiptsPage', ['aqua', 'goods-receipts']);
const FeedingsPage = lazyImport(() => import('@/features/feedings/components/FeedingsPage.tsx'), 'FeedingsPage', ['aqua', 'feedings']);
const MortalitiesPage = lazyImport(() => import('@/features/mortalities/components/MortalitiesPage.tsx'), 'MortalitiesPage', ['aqua', 'mortalities']);
const TransfersPage = lazyImport(() => import('@/features/transfers/components/TransfersPage.tsx'), 'TransfersPage', ['aqua', 'transfers']);
const WarehouseTransfersPage = lazyImport(() => import('@/features/transfers/components/WarehouseTransfersPage.tsx'), 'WarehouseTransfersPage', ['aqua', 'transfers']);
const CageWarehouseTransfersPage = lazyImport(() => import('@/features/transfers/components/CageWarehouseTransfersPage.tsx'), 'CageWarehouseTransfersPage', ['aqua', 'transfers']);
const WarehouseCageTransfersPage = lazyImport(() => import('@/features/transfers/components/WarehouseCageTransfersPage.tsx'), 'WarehouseCageTransfersPage', ['aqua', 'transfers']);
const ShipmentsPage = lazyImport(() => import('@/features/shipments/components/ShipmentsPage.tsx'), 'ShipmentsPage', ['aqua', 'shipments']);
const WeighingsPage = lazyImport(() => import('@/features/weighings/components/WeighingsPage.tsx'), 'WeighingsPage', ['aqua', 'weighings']);
const StockConvertsPage = lazyImport(() => import('@/features/stock-converts/components/StockConvertsPage.tsx'), 'StockConvertsPage', ['aqua', 'stock-converts']);
const FishBatchesPage = lazyImport(() => import('@/features/fish-batches/components/FishBatchesPage.tsx'), 'FishBatchesPage', ['aqua', 'fish-batches']);
const DailyWeathersPage = lazyImport(() => import('@/features/daily-weathers/components/DailyWeathersPage.tsx'), 'DailyWeathersPage', ['aqua', 'daily-weathers']);
const NetOperationsPage = lazyImport(() => import('@/features/net-operations/components/NetOperationsPage.tsx'), 'NetOperationsPage', ['aqua', 'net-operations']);
const GoodsReceiptLinesPage = lazyImport(() => import('@/features/goods-receipts/components/GoodsReceiptLinesPage.tsx'), 'GoodsReceiptLinesPage', ['aqua', 'goods-receipts']);
const GoodsReceiptFishDistributionsPage = lazyImport(() => import('@/features/goods-receipts/components/GoodsReceiptFishDistributionsPage.tsx'), 'GoodsReceiptFishDistributionsPage', ['aqua', 'goods-receipts']);
const FeedingLinesPage = lazyImport(() => import('@/features/feedings/components/FeedingLinesPage.tsx'), 'FeedingLinesPage', ['aqua', 'feedings']);
const FeedingDistributionsPage = lazyImport(() => import('@/features/feedings/components/FeedingDistributionsPage.tsx'), 'FeedingDistributionsPage', ['aqua', 'feedings']);
const TransferLinesPage = lazyImport(() => import('@/features/transfers/components/TransferLinesPage.tsx'), 'TransferLinesPage', ['aqua', 'transfers']);
const WarehouseTransferLinesPage = lazyImport(() => import('@/features/transfers/components/WarehouseTransferLinesPage.tsx'), 'WarehouseTransferLinesPage', ['aqua', 'transfers']);
const CageWarehouseTransferLinesPage = lazyImport(() => import('@/features/transfers/components/CageWarehouseTransferLinesPage.tsx'), 'CageWarehouseTransferLinesPage', ['aqua', 'transfers']);
const WarehouseCageTransferLinesPage = lazyImport(() => import('@/features/transfers/components/WarehouseCageTransferLinesPage.tsx'), 'WarehouseCageTransferLinesPage', ['aqua', 'transfers']);
const ShipmentLinesPage = lazyImport(() => import('@/features/shipments/components/ShipmentLinesPage.tsx'), 'ShipmentLinesPage', ['aqua', 'shipments']);
const MortalityLinesPage = lazyImport(() => import('@/features/mortalities/components/MortalityLinesPage.tsx'), 'MortalityLinesPage', ['aqua', 'mortalities']);
const WeighingLinesPage = lazyImport(() => import('@/features/weighings/components/WeighingLinesPage.tsx'), 'WeighingLinesPage', ['aqua', 'weighings']);
const StockConvertLinesPage = lazyImport(() => import('@/features/stock-converts/components/StockConvertLinesPage.tsx'), 'StockConvertLinesPage', ['aqua', 'stock-converts']);
const NetOperationLinesPage = lazyImport(() => import('@/features/net-operations/components/NetOperationLinesPage.tsx'), 'NetOperationLinesPage', ['aqua', 'net-operations']);
const BatchMovementsPage = lazyImport(() => import('@/features/batch-movements/components/BatchMovementsPage.tsx'), 'BatchMovementsPage', ['aqua', 'batch-movements']);
const CageBalancesPage = lazyImport(() => import('@/features/cage-balances/components/CageBalancesPage.tsx'), 'CageBalancesPage', ['aqua', 'cage-balances']);
const ProjectDetailReportPage = lazyImport(() => import('@/features/project-detail-report/components/ProjectDetailReportPage.tsx'), 'ProjectDetailReportPage', 'aqua');
const AquaDashboardPage = lazyImport(() => import('@/features/aqua-dashboard/components/AquaDashboardPage.tsx'), 'AquaDashboardPage', 'aqua');
const RawKpiReportPage = lazyImport(() => import('@/features/raw-kpi-report/components/RawKpiReportPage.tsx'), 'RawKpiReportPage', 'aqua');
const BusinessKpiReportPage = lazyImport(() => import('@/features/business-kpi-report/components/BusinessKpiReportPage.tsx'), 'BusinessKpiReportPage', 'aqua');
const DevirFcrReportPage = lazyImport(() => import('@/features/devir-fcr-report/components/DevirFcrReportPage.tsx'), 'DevirFcrReportPage', 'aqua');
const QuickSetupPage = lazyImport(() => import('@/features/quick-setup/QuickSetupPage.tsx'), 'QuickSetupPage', 'aqua');
const QuickDailyEntryPage = lazyImport(() => import('@/features/quick-daily-entry/QuickDailyEntryPage.tsx'), 'QuickDailyEntryPage', 'aqua');
const OpeningImportPage = lazyImport(() => import('@/features/opening-import/OpeningImportPage.tsx'), 'OpeningImportPage', 'aqua');
const ProjectMergesPage = lazyImport(() => import('@/features/project-merges/pages/ProjectMergesPage.tsx'), 'ProjectMergesPage', 'aqua');
