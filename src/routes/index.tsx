...
const ProjectsPage = lazyImport(() => import('@/features/projects/components/ProjectsPage.tsx'), 'ProjectsPage', 'aqua');
const CagesPage = lazyImport(() => import('@/features/cages/components/CagesPage.tsx'), 'CagesPage', 'aqua');
const CageWarehouseMappingsPage = lazyImport(() => import('@/features/cages/components/CageWarehouseMappingsPage.tsx'), 'CageWarehouseMappingsPage', 'aqua');
const ProjectCageAssignmentsPage = lazyImport(() => import('@/features/project-cages/components/ProjectCageAssignmentsPage.tsx'), 'ProjectCageAssignmentsPage', 'aqua');
const WeatherSeveritiesPage = lazyImport(() => import('@/features/weather/components/WeatherSeveritiesPage.tsx'), 'WeatherSeveritiesPage', 'aqua');
const WeatherTypesPage = lazyImport(() => import('@/features/weather/components/WeatherTypesPage.tsx'), 'WeatherTypesPage', 'aqua');
const SeaWaterTemperaturesPage = lazyImport(() => import('@/features/sea-water-temperature/components/SeaWaterTemperaturesPage.tsx'), 'SeaWaterTemperaturesPage', 'aqua');
const WindDirectionsPage = lazyImport(() => import('@/features/wind-direction/components/WindDirectionsPage.tsx'), 'WindDirectionsPage', 'aqua');
const CurrentDirectionsPage = lazyImport(() => import('@/features/current-direction/components/CurrentDirectionsPage.tsx'), 'CurrentDirectionsPage', 'aqua');
const NetOperationTypesPage = lazyImport(() => import('@/features/net-operations/components/NetOperationTypesPage.tsx'), 'NetOperationTypesPage', 'aqua');
const AquaSettingsPage = lazyImport(() => import('@/features/aqua-settings/pages/AquaSettingsPage.tsx'), 'AquaSettingsPage', 'aqua');
const GoodsReceiptsPage = lazyImport(() => import('@/features/goods-receipts/components/GoodsReceiptsPage.tsx'), 'GoodsReceiptsPage', 'aqua');
const FeedingsPage = lazyImport(() => import('@/features/feedings/components/FeedingsPage.tsx'), 'FeedingsPage', 'aqua');
const MortalitiesPage = lazyImport(() => import('@/features/mortalities/components/MortalitiesPage.tsx'), 'MortalitiesPage', 'aqua');
const TransfersPage = lazyImport(() => import('@/features/transfers/components/TransfersPage.tsx'), 'TransfersPage', 'aqua');
const WarehouseTransfersPage = lazyImport(() => import('@/features/transfers/components/WarehouseTransfersPage.tsx'), 'WarehouseTransfersPage', 'aqua');
const CageWarehouseTransfersPage = lazyImport(() => import('@/features/transfers/components/CageWarehouseTransfersPage.tsx'), 'CageWarehouseTransfersPage', 'aqua');
const WarehouseCageTransfersPage = lazyImport(() => import('@/features/transfers/components/WarehouseCageTransfersPage.tsx'), 'WarehouseCageTransfersPage', 'aqua');
const ShipmentsPage = lazyImport(() => import('@/features/shipments/components/ShipmentsPage.tsx'), 'ShipmentsPage', 'aqua');
const WeighingsPage = lazyImport(() => import('@/features/weighings/components/WeighingsPage.tsx'), 'WeighingsPage', 'aqua');
const StockConvertsPage = lazyImport(() => import('@/features/stock-converts/components/StockConvertsPage.tsx'), 'StockConvertsPage', 'aqua');
const FishBatchesPage = lazyImport(() => import('@/features/fish-batches/components/FishBatchesPage.tsx'), 'FishBatchesPage', 'aqua');
const DailyWeathersPage = lazyImport(() => import('@/features/daily-weathers/components/DailyWeathersPage.tsx'), 'DailyWeathersPage', 'aqua');
const NetOperationsPage = lazyImport(() => import('@/features/net-operations/components/NetOperationsPage.tsx'), 'NetOperationsPage', 'aqua');
const GoodsReceiptLinesPage = lazyImport(() => import('@/features/goods-receipts/components/GoodsReceiptLinesPage.tsx'), 'GoodsReceiptLinesPage', 'aqua');
const GoodsReceiptFishDistributionsPage = lazyImport(() => import('@/features/goods-receipts/components/GoodsReceiptFishDistributionsPage.tsx'), 'GoodsReceiptFishDistributionsPage', 'aqua');
const FeedingLinesPage = lazyImport(() => import('@/features/feedings/components/FeedingLinesPage.tsx'), 'FeedingLinesPage', 'aqua');
const FeedingDistributionsPage = lazyImport(() => import('@/features/feedings/components/FeedingDistributionsPage.tsx'), 'FeedingDistributionsPage', 'aqua');
const TransferLinesPage = lazyImport(() => import('@/features/transfers/components/TransferLinesPage.tsx'), 'TransferLinesPage', 'aqua');
const WarehouseTransferLinesPage = lazyImport(() => import('@/features/transfers/components/WarehouseTransferLinesPage.tsx'), 'WarehouseTransferLinesPage', 'aqua');
const CageWarehouseTransferLinesPage = lazyImport(() => import('@/features/transfers/components/CageWarehouseTransferLinesPage.tsx'), 'CageWarehouseTransferLinesPage', 'aqua');
const WarehouseCageTransferLinesPage = lazyImport(() => import('@/features/transfers/components/WarehouseCageTransferLinesPage.tsx'), 'WarehouseCageTransferLinesPage', 'aqua');
const ShipmentLinesPage = lazyImport(() => import('@/features/shipments/components/ShipmentLinesPage.tsx'), 'ShipmentLinesPage', 'aqua');
const MortalityLinesPage = lazyImport(() => import('@/features/mortalities/components/MortalityLinesPage.tsx'), 'MortalityLinesPage', 'aqua');
const WeighingLinesPage = lazyImport(() => import('@/features/weighings/components/WeighingLinesPage.tsx'), 'WeighingLinesPage', 'aqua');
const StockConvertLinesPage = lazyImport(() => import('@/features/stock-converts/components/StockConvertLinesPage.tsx'), 'StockConvertLinesPage', 'aqua');
const NetOperationLinesPage = lazyImport(() => import('@/features/net-operations/components/NetOperationLinesPage.tsx'), 'NetOperationLinesPage', 'aqua');
const BatchMovementsPage = lazyImport(() => import('@/features/batch-movements/components/BatchMovementsPage.tsx'), 'BatchMovementsPage', 'aqua');
const CageBalancesPage = lazyImport(() => import('@/features/cage-balances/components/CageBalancesPage.tsx'), 'CageBalancesPage', 'aqua');
